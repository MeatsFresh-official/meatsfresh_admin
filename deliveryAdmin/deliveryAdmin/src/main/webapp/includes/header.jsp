...
<head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/resources/images/url-image-logo.png" type="image/png" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/dashboard.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/common/header-menu.css">
    <!-- Scripts -->
    ...
    <header class="header">
        ...
        <div class="header-right">
            ...
            <div class="user-profile dropdown">
                <c:choose>
                    <c:when test="${not empty currentStaff.profileImage}">
                        <img src="${pageContext.request.contextPath}${currentStaff.profileImage}"
                    ...
                    <c:otherwise>
                        <img src="${pageContext.request.contextPath}/resources/images/user-setting.png"
                             alt="${currentStaff.name}"
                             class="dropdown-toggle"
                             data-bs-toggle="dropdown"
                             aria-expanded="false">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="generateOtpBtn">Generate OTP</button>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="verifyOtpBtn">Verify OTP</button>
                            </div>
