    ...
    <ul class="nav flex-column">
      ...
      <c:if test="${fn:contains(currentStaff.accessPages, 'VENDOR_MANAGEMENT')}">
        <li class="nav-item">
          ...
          <div class="collapse ${pageContext.request.requestURI.contains('/shop') ? 'show' : ''}" id="vendorCollapse">
            <ul class="nav flex-column submenu">
      ...
      <c:if test="${fn:contains(currentStaff.accessPages, 'DELIVERY_SYSTEM')}">
        <li class="nav-item">
          ...
          <div class="collapse ${pageContext.request.requestURI.contains('/deliveryBoy') ? 'show' : ''}" id="deliveryCollapse">
            <ul class="nav flex-column submenu">
      ...
      <c:if test="${fn:contains(currentStaff.accessPages, 'SYSTEM_SETTINGS')}">
        <li class="nav-item">
          ...
          <div class="collapse ${pageContext.request.requestURI.contains('/admin-staff') ? 'show' : ''}" id="systemCollapse">
            <ul class="nav flex-column submenu">
