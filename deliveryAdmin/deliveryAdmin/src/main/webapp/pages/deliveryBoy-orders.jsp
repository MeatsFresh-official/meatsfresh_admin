                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body tab-content" id="orderTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="all-orders" role="tabpanel">
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            ...
                                            <div class="col-md-6 text-end">
                                                <div class="btn-group" role="group">
                                                    <button class="btn btn-outline-secondary" id="filterOrdersBtn"
                                        ...
                                        <!-- Pagination -->
                                        <div id="allOrdersPagination" class="mt-3"></div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="pending" role="tabpanel">
                                        <div class="table-responsive">
                                            <table class="table table-hover" id="pendingOrdersTable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="7" class="text-center">
                                                            <i class="fas fa-spinner fa-spin me-2"></i>Loading pending
                                                            orders...
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <!-- Pagination -->
                                        <div id="pendingOrdersPagination" class="mt-3"></div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="completed" role="tabpanel">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td colspan="6" class="text-center">
                                                            <i class="fas fa-spinner fa-spin me-2"></i>Loading completed
                                                            orders...
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <!-- Pagination -->
                                        <div id="completedOrdersPagination" class="mt-3"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" id="updateStatusBtn">Update
                                        Status</button>
                                </div>
                            </div>
                        </div>
